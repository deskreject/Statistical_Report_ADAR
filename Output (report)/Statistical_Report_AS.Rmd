...
- hurdle model is chosen as appropriate as all the observations are "at risk" of producing an answer, hence 0s are assumed to have arisen due to sampling only and not due to structural reasons (Rose et al 2006)
...
#try this for a poisson distribution
Ord_plot(w_panel_matched_qual_6m_unalt_b$actions)
