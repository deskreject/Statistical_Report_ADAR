...
Furthermore, the rootograms of the count models are presented, which can be used to assess the predictive capabilties of the underlying models. 
...
outlierTest(negbi_matched_unalt_asw_6m)
residualPlots(negbi_matched_unalt_asw_6m)
```
